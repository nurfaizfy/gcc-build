...
export OPT_FLAGS="-O3 -flto=${NPROC} -fipa-pta -pipe -ffunction-sections -fdata-sections -fgraphite -fgraphite-identity -floop-nest-optimize -march=x86-64-v3 -mpclmul -Wl,-S,--gc-sections"
