...
export OPT_FLAGS="-O3 -flto=${NPROC} -fipa-pta -pipe -ffunction-sections -fdata-sections -fgraphite -fgraphite-identity -floop-nest-optimize -march=haswell -mtune=haswell -Wl,-S,--gc-sections"
